...
/* tbl_TEST10, table with upper case letter*/
...
/* tbl_TEST11, key with upper case letter*/

DROP TABLE IF EXISTS `tbl_test11_0000`;
CREATE TABLE `tbl_test11_0000`(
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `c` int(11) NOT NULL,
  `SK` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `tbl_test11_0001`;
CREATE TABLE `tbl_test11_0001`(
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `c` int(11) NOT NULL,
  `SK` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `tbl_test11_0002`;
CREATE TABLE `tbl_test11_0002`(
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `c` int(11) NOT NULL,
  `SK` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
